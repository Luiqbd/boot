...
public final class ActivityChatsBinding implements ViewBinding {
  ...
  private ActivityChatsBinding(@NonNull CoordinatorLayout rootView, @NonNull RecyclerView rvChats,
  ...
  public static ActivityChatsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityChatsBinding((CoordinatorLayout) rootView, rvChats, toolbar);
    }
